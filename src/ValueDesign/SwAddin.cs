...
{
    /// <summary>
    /// Summary description for ValueDesign.
    /// </summary>
    [Guid("03cd92e8-0ebd-426b-9b13-34b0e2c66228"), ComVisible(true)]
    [SwAddin(
        Description = "ValueDesign description",
        Title = "ValueDesign",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("ValueDesign.MainIconLarge.bmp", thisAssembly);
