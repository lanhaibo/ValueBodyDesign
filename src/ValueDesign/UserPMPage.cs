...
namespace ValueDesign
{
    public class UserPMPage
    {
        ...
        protected void AddControls()
        {
            ...
            group1 = (IPropertyManagerPageGroup)swPropertyPage.AddGroupBox(group1ID, "阀孔插入", options);

            options = (int)swAddGroupBoxOptions_e.swGroupBoxOptions_Checkbox |
                      (int)swAddGroupBoxOptions_e.swGroupBoxOptions_Visible;

            group2 = (IPropertyManagerPageGroup)swPropertyPage.AddGroupBox(group2ID, "油孔插入", options);
